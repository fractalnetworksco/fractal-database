    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_repr_id', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddConstraint(
            model_name='database',
            constraint=models.UniqueConstraint(condition=models.Q(('is_self', True)), fields=('is_self',), name='fractal_database_database_unique_self_singleton'),
        ),
        migrations.AddConstraint(
